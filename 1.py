...
def banner():
    print("""
      _                                _                 
     | |                              | |                
  ___| |__   ___  _ __   __ _  ___ ___| |__  _ __   __ _ 
 |_  / '_ \ / _ \| '_ \ / _` |/ __/ _ \ '_ \| '_ \ / _` |
  / /| | | | (_) | | | | (_| | (_|  __/ | | | | | | (_| |
 /___|_| |_|\___/|_| |_|\__, |\___\___|_| |_|_| |_|\__, |
                         __/ |                      __/ |
                        |___/                      |___/ 
                                                                                            lpyydxs
    """)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="这是一个中成科信票务管理系统 UploadHandler.ashx 任意文件上传漏洞检测程序")
